...
export const V1_MESSAGE_LIST_ENDPOINT = `${process.env.API_ROOT}/v1/message/list`;
export const V1_MESSAGE_ENDPOINT = `${process.env.API_ROOT}/v1/message`;
export const V1_WHOAMI_ENDPOINT = `${process.env.API_ROOT}/v1/whoami`;
export const PLAYLIST_ENDPOINT = 'https://tuzach.in/api/?app=playlist';
export const TOPIC_ENDPOINT = `${process.env.API_ROOT}/v1/topic`;
